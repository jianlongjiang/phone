...
//$.ui.popup=alert;
var BASE_URL = "http://yinglian.hzlianhai.com";
//BASE_URL = "http://localhost:8080";
var BASE_IMAGE = BASE_URL + "/resources/admin/store/";
var  appName = "yinglian"; // app 名字,  图片存放目录
...
function autoLogin(isCheck,options) {
	...
	$.ajax({
		...
		url : BASE_URL + "/app/admin/autoLogin",
		dataType : "json"
	});
//	.then(function(data) {
//		alert("auto---login");
 ...
 * fromId  为 "xx";
 */
function setFormValue(fromId, json){
	fromId = "#"+fromId;
	$(fromId + "  input").each(
			function(index) {
