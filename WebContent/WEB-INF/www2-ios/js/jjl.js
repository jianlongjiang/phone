...
function  into_orderDetails(){
	$('body').css("background","#13b09b");
}
function out_orderDetails(){
...
function into_integralRed() {
	...
	$("body").css("background","#d55645");
	if(!isBlack(StatusBar)){
		StatusBar.styleLightContent();
//		StatusBar.overlaysWebView(false);
//		
//		StatusBar.backgroundColorByHexString("#d55645");
	//	StatusBar.backgroundColorByName("red");
	}
		...
		success : function(r) {
			if (r.isSuccess) {
				...
				if (list.length == 0) {
					...
					//  $.ui.addDivAndScroll($("#user-message-div .list"));
				}
			}
		}
	});
