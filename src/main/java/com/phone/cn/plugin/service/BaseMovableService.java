...
import com.phone.cn.plugin.entity.Movable;
 ...
 * <p>Version: 1.0
 */
public abstract class BaseMovableService<M extends BaseEntity<ID> & Movable, ID extends Serializable> extends BaseService<M, ID> {
