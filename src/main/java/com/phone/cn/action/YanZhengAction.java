...
public class YanZhengAction {
	...
	public Boolean yanzheng(@RequestParam String yzm, HttpServletRequest request){
		if(StringUtils.isNotEmpty(yzm) && yzm.equalsIgnoreCase(String.valueOf(request.getSession().getAttribute("yanzhengma")))){
			return Boolean.TRUE;
		}
	...
	public void getCode(HttpServletRequest req, HttpServletResponse resp)
		...
		logging.info("============>code:"+randomCode.toString());
