...
import com.phone.cn.conf.MobileAlipayConfig;
import com.phone.cn.utils.alipay.httpclient.HttpProtocolHandler;
import com.phone.cn.utils.alipay.httpclient.HttpRequest;
import com.phone.cn.utils.alipay.httpclient.HttpResponse;
import com.phone.cn.utils.alipay.httpclient.HttpResultType;
...
public class MobileAlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
    	String prestr = MobileAlipayCore.createLinkString(sPara); //把数组所有元素，按照“参数=参数值”的模式用“&”字符拼接成字符串
    	String mysign = "";
        if(MobileAlipayConfig.sign_type.equals("MD5") ) {
        	mysign = MobileMd5.sign(prestr, MobileAlipayConfig.key, MobileAlipayConfig.input_charset);
        }
        if(MobileAlipayConfig.sign_type.equals("0001") ){
        	mysign = RSA.sign(prestr, MobileAlipayConfig.private_key, MobileAlipayConfig.input_charset);
        }
        return mysign;
    }
    ...
    private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) {
        //除去数组中的空值和签名参数
        Map<String, String> sPara = MobileAlipayCore.paraFilter(sParaTemp);
        //生成签名结果
        ...
        if(! sPara.get("service").equals("alipay.wap.trade.create.direct") && ! sPara.get("service").equals("alipay.wap.auth.authAndExecute")) {
        	sPara.put("sign_type", MobileAlipayConfig.sign_type);
        }
    ...
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        ...
        sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"" + ALIPAY_GATEWAY_NEW
                      + "_input_charset=" + MobileAlipayConfig.input_charset + "\" method=\"" + strMethod
                      + "\">");
    ...
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, String strParaFileName, String strFilePath,Map<String, String> sParaTemp) throws Exception {
        ...
        //设置编码集
        request.setCharset(MobileAlipayConfig.input_charset);

        request.setParameters(generatNameValuePair(sPara));
        request.setUrl(ALIPAY_GATEWAY_NEW+"_input_charset="+MobileAlipayConfig.input_charset);
    ...
    public static String getRequestToken(String text) throws Exception {
    	...
    	if (paraText.get("res_data") != null) {
    		...
    		if(MobileAlipayConfig.sign_type.equals("0001")) {
    			res_data = RSA.decrypt(res_data, MobileAlipayConfig.private_key, MobileAlipayConfig.input_charset);
    		}
	...
	public static String query_timestamp() throws MalformedURLException,
        ...
        String strUrl = "https://mapi.alipay.com/gateway.do?service=query_timestamp&partner=" + MobileAlipayConfig.partner;
